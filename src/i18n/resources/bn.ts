...
export const bn: LocaleResource = {
  ...
  footer: {
    ...
    demonstrationBody:
      'নকশি সিনেমাস কোনো সত্যিকারের সিনেমা চেইন নয়। এই সাইটের প্রতিটি ছবি, হল, সময়সূচি, আসন, দাম, অফার ও নীতিমালা এই প্রকল্পের জন্য লেখা নমুনা তথ্য। কোনো টাকা নেওয়া হয় না এবং কোনো তথ্য আপনার ব্রাউজারের বাইরে যায় না — বুকিং কেবল এই ব্রাউজারের লোকাল স্টোরেজে জমা থাকে।',
    copyright: '© {{year}} নকশি সিনেমাস',
  },
  ...
  featured: {
    demoNote:
      'নকশি সিনেমাস একটি ডেমো বিল্ড — ছবি, সময়সূচি ও দাম সবই নমুনা তথ্য। গেস্ট হিসেবেই বুকিং শেষ করতে পারবেন; কোনো টাকা নেওয়া হয় না।',
  },
  ...
  movieDetails: {
    ...
    notRealListings: 'এগুলো নকশি সিনেমাসের সত্যিকারের তালিকা নয় এবং এখানে কিছুই সত্যিকারের আসন-তথ্য দেখায় না।',
  ...
  metadata: {
    titleTemplate: '{{page}} — নকশি সিনেমাস',
    booking: 'বুকিং',
    confirmation: 'আপনার টিকিট',
    notFound: 'পাতাটি পাওয়া যায়নি',
    siteName: 'নকশি সিনেমাস',
    home: 'প্রোগ্রাম',
    description:
      'নকশি সিনেমাস — প্রোগ্রাম দেখুন, শোটাইম তুলনা করুন এবং আসন বুক করুন। এটি একটি স্থানীয়, ফ্রন্টএন্ড-only ডেমো বিল্ড।',
  },
};
